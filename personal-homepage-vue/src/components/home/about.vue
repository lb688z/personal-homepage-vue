...
const initAboutAnimatin = (quoteRef: Ref<HTMLElement | undefined>, targetSection: Ref<HTMLElement | undefined>): ScrollTrigger => {
...
useEffect(() => {
  const aboutScrollTriggerInstance = initAboutAnimatin(quoteRef, targetSection);
